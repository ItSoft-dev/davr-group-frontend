...
const fleetPreviewImage =
  "https://t4.ftcdn.net/jpg/08/28/48/99/360_F_828489997_RRqV41sukqs6K7LzMVlD1nYhl7xvaAtC.jpg";
...
const fallbackTestimonials = [
  {
    ...
    content: "Davr Group has been our go-to carrier for the past year.",
    rating: 5,
  },
  {
    id: "fallback-2",
    ...
    company: "Midwest Distributors",
    content: "Working with Davr Group has streamlined our shipping operations.",
    rating: 5,
  },
  {
    id: "fallback-3",
    ...
    company: "RouteSpan Inc.",
    content:
      "They communicate clearly, show up on schedule, and keep every load moving.",
    rating: 5,
  },
  {
    id: "fallback-4",
    ...
    content:
      "Fast response times and dependable service made them easy to trust quickly.",
    rating: 5,
  },
  {
    id: "fallback-5",
    ...
    content:
      "Their team handles urgent shipments calmly and professionally every single time.",
    rating: 5,
  },
  {
    id: "fallback-6",
    ...
    company: "NorthPoint Retail",
    content:
      "Reliable pickups and clean communication helped us reduce delivery stress.",
    rating: 5,
  },
  {
    id: "fallback-7",
    name: "Kevin Mitchell",
    role: "Dispatch Partner",
    company: "InterState Cargo",
    content: "Davr Group feels like an extension of our own operations team.",
    rating: 5,
  },
  {
    id: "fallback-8",
    ...
    content:
      "Consistent performance and courteous drivers made a strong impression on our team.",
    rating: 5,
  },
];
...
const Index = () => {
  ...
  const { data: reasons = [] } = useQuery({
    ...
    queryFn: publicApi.getWhyChooseUs,
  });
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold leading-[1.1] mb-6 animate-fade-up animation-delay-200">
              {heroData ? (
                ...
                <>
                  Reliable Trucking <br className="hidden sm:block" />
                  Services <span className="text-gradient">Across the USA</span>
                </>
              )}
            </h1>
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-xl leading-relaxed animate-fade-up animation-delay-400">
              {heroData?.subtitle ||
                "Fast, safe, and on-time freight delivery you can trust. DAVR GROUP LLC — your dependable partner for interstate logistics."}
            </p>
            ...
            <div className="flex flex-wrap gap-4 animate-fade-up animation-delay-600">
              <Link to="/quote">
                <Button
                  size="lg"
                  className="gap-2 h-12 px-8 text-base shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all"
                >
              ...
              <a href={`tel:${phoneHref}`}>
                <Button
                  size="lg"
                  variant="outline"
                  className="gap-2 h-12 px-8 text-base border-white/20 text-white hover:bg-white/10"
                >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              From full truckloads to expedited shipping — we move your freight
              safely and on time.
            </p>
          </div>
            ...
            {featuredServices.map((s: any) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative rounded-[32px] border border-border/50 bg-card/50 p-7 shadow-sm transition-all duration-500 hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/10 md:p-8">
                    ...
                    <div className="relative flex min-h-[280px] flex-col justify-between">
                      <div>
                        ...
                        <h3 className="font-bold text-xl md:text-[1.4rem] mb-2 tracking-tight">
                          {s.title}
                        </h3>
                        <p className="text-sm md:text-[15px] text-muted-foreground leading-relaxed max-w-md pr-6">
                          {s.description}
                        </p>
                      </div>
                      <div className="mt-8 rounded-[22px] border border-border/40 bg-background/50 px-4 py-3 backdrop-blur-sm">
                        <div>
      ...
      <section className="py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              We may be small, but our commitment to quality and reliability is
              second to none.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-bold mb-6">
                Well-Maintained <span className="text-gradient">Equipment</span>
              </h2>
              <p className="text-muted-foreground mb-8 leading-relaxed text-lg">
                Our fleet of trucks is regularly serviced and equipped with GPS
                tracking for real-time shipment visibility. Every vehicle meets
          ...
          <div className="w-full max-w-none mx-auto">
            <div className="text-center mb-12 md:mb-16">
              ...
              <p className="mx-auto max-w-2xl text-muted-foreground text-base md:text-lg">
                Swipe through a broader mix of partner feedback from daily
                freight coordination, dispatch, and retail logistics teams.
              </p>
            </div>
                  ...
                  >
                    <div className="group flex h-full min-h-[330px] flex-col rounded-[28px] border border-border/50 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.01))] p-5 md:p-6 transition-all duration-500 hover:-translate-y-1 hover:border-primary/20 hover:shadow-2xl hover:shadow-primary/10 dark:bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.01))]">
                      <div className="mb-4 flex items-center justify-between gap-3">
                        ...
                        <span className="rounded-full border border-primary/15 bg-primary/5 px-2.5 py-1 text-[9px] font-semibold uppercase tracking-[0.18em] text-primary">
                          Verified
                        </span>
                      </div>
                      <div className="mb-4 h-px w-full bg-gradient-to-r from-primary/20 via-border/50 to-transparent" />
                      <p className="flex-1 text-[15px] leading-7 text-muted-foreground italic">
                        "{t.content}"
                      </p>
        ...
        <div className="container mx-auto px-4 text-center relative">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg mb-10 leading-relaxed">
              Get a free quote today. We'll get your freight moving quickly,
              safely, and at a competitive rate.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Link to="/contact">
                <Button
                  size="lg"
                  variant="outline"
                  className="gap-2 h-12 px-8 text-base border-border hover:bg-muted/50"
                >
                  Contact Us
                </Button>
              </Link>
            ...
            <p className="text-xs text-muted-foreground mt-6">
              No obligation. We typically respond within 2 hours during business
              hours.
            </p>
          </div>
        </div>
