...
import {
  ...
  Users, Settings, LogOut, Menu, X, Star, BarChart3, Globe, Clock, Shield, Zap, Scale, UserCheck,
} from "lucide-react";
...
const navItems = [
  ...
  { to: "/admin/driver-applications", icon: UserCheck, label: "Driver Applications" },
