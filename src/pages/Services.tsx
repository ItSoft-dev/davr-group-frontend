          ...
          <div className="space-y-8 max-w-5xl mx-auto">
            {services.map((s: any, i: number) => {
              ...
              return (
                <div
                  key={s.id}
                  className={`group relative flex flex-col md:flex-row gap-8 p-8 md:p-10 rounded-2xl border border-border/50 bg-card/30 hover:bg-card/60 transition-all duration-500 hover:border-${color}/30`}
                >
                  <div
                    className={`absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-r from-${color}/5 to-transparent`}
                  />
                  <div className="relative flex-shrink-0">
                    <div
                      className={`w-16 h-16 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-all duration-300 bg-${color}/10 group-hover:bg-${color}/15`}
                    >
                  ...
                  <div className="relative flex-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                      {features.map((f: string) => (
                        ...
                        >
                          <CheckCircle2
                            className={`h-4 w-4 flex-shrink-0 text-${color}`}
                          />
