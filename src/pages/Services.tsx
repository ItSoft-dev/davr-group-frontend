...
const servicesHeroImage =
  "https://imgproxy.divecdn.com/lj2LpQ06LZtyVcc_5_UZnf1sWuxwDXF-hGuaQuSOoew/g:ce/rs:fill:1600:900:1/Z3M6Ly9kaXZlc2l0ZS1zdG9yYWdlL2RpdmVpbWFnZS9HZXR0eUltYWdlcy0xODQ4Mzc3ODkwLmpwZw==.webp";
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Whether you need a full truckload or expedited delivery,
              <br /> DAVR GROUP LLC has the service to match your needs.
            </p>
